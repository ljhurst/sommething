...
export default function AnalyticsPage() {
  ...
  if (!analytics || analytics.totalBottles === 0) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white p-4">
        <div className="max-w-7xl mx-auto">
          <Link
            href="/"
            className="inline-flex items-center text-wine-red hover:text-wine-red/80 mb-6"
          >
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white p-4">
      <div className="max-w-7xl mx-auto">
        <div className="mb-6">
          <Link
            href="/"
            className="inline-flex items-center text-wine-red hover:text-wine-red/80 mb-4"
          >
            <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                strokeLinecap="round"
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-500 mt-1">
                    {analytics.oldestBottle.year} • {formatPrice(analytics.oldestBottle.price)}
                  </div>
                </div>
              </div>
            </div>
          ...
          {analytics.mostExpensiveBottle && (
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="flex items-start gap-4">
                <div
                  className="w-16 h-16 rounded-full flex-shrink-0"
                  style={{ backgroundColor: getWineColor(analytics.mostExpensiveBottle.type) }}
                />
                <div>
                  <div className="font-bold text-lg text-gray-900">
