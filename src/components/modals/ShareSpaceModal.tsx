...
import { CrownIcon, PencilIcon, EyeIcon } from '@/components/icons';
...
export function ShareSpaceModal({ isOpen, space, onClose }: ShareSpaceModalProps) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={`Share ${space.name}`} maxWidth="lg">
                ...
                <div className="space-y-2">
                  <label className="flex items-center">
                    ...
                    <div>
                      ...
                      <span className="text-sm text-gray-600 ml-2">Can add and remove bottles</span>
                    </div>
                  </label>
                  <label className="flex items-center">
                    <input
