...
export function EmptySlot({ slotNumber, onClick }: EmptySlotProps) {
  return (
    <div className="relative w-full">
      ...
      <button
        onClick={onClick}
        className="w-full aspect-square rounded-full border-2 border-dashed border-gray-300 bg-gray-50 transition-all hover:border-wine-red hover:bg-gray-100 active:scale-95 focus:outline-none focus:ring-2 focus:ring-wine-red focus:ring-offset-2"
